...
/**
 * con_string - Converts an argument to a string and
...
/**
 * con_S - Converts an argument to a string and
 *             stores it to a buffer contained in a struct.
 * @args: A va_list pointing to the argument to be converted.
 * @flags: Flag modifiers.
 * @wid: A width modifier.
...
/**
 * con_r - Reverses a string and stores it
...
/**
 * con_R - Converts a string to ROT13 and stores
