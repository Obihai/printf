...
/**
 * con_di - Converts an argument to a signed int and
...
/**
 * con_b - Converts an unsigned int argument to binary
...
/**
 * con_o - Converts an unsigned int to octal and
 *             stores it to a buffer contained in a struct.
...
/**
 * con_u - Converts an unsigned int argument to decimal and
 *               stores it to a buffer contained in a struct.
 * @args: A va_list pointing to the argument to be converted.
 * @flags: Flag modifiers.
 * @wid: A width modifier.
